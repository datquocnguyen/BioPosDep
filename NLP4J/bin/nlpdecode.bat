...
%JAVACMD% %JAVA_OPTS% -Xmx8g -XX:+UseConcMarkSweepGC -classpath %CLASSPATH% -Dapp.name="nlpdecode" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" edu.emory.mathcs.nlp.bin.NLPDecode %CMD_LINE_ARGS%
